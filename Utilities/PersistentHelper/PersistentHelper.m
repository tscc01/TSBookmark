...
- (void)saveString:(NSString*)strValue forKey:(NSString*)strKey;
{
    ...
    PersistentHelperObject *object = nil;
    
    @try {
        object = [PersistentHelperObject SQPFetchOneByAttribut:@"strKey" withValue:strKey];
    ...
    NSData *data = [TNCryptor dataByAES256WithString:strValue forKey:[[STSispertent sharedInstance]stSispertent]];
...
- (NSString*)getStringForKey:(NSString*)strKey;
{
    ...
    if (object) {
        ...
        NSData *data = [strRet base64DecodedData];
        strRet = [TNCryptor stringByAES256WithData:data forKey:[[STSispertent sharedInstance]stSispertent]];
